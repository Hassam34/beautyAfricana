    ...
    renderHeader = () => {
        return (
            <View style={styles.headerStyle}>
                ...
                <View style={{ flex: .8 }}>
                    <Text style={styles.textStyleHeader}>Messages</Text>
            ...
            <TouchableOpacity>
                <View style={{ padding: 10 }}>
                    <View style={{ flexDirection: 'row', flex: 1 }}>
                        ...
                        <View style={{ flex: 6.5 }}>
                            <Text style={{ fontSize: 16, fontWeight: 'bold',color:constants.whiteColor }}>
                                {data.name}
                            </Text>
                            <Text style={{ fontSize: 14, color:constants.slowWhiteColor }}>
                                {data.message}
                            </Text>
                        </View>
                        <View style={{ flex: 2 }}>
